...
async function seed() {
  ...
  const seedProfiles: SeedProfile[] = [
    { fullName: 'أحمد محمد', phone: '0770000001', email: 'seed_student1@uniride.local', password: '123456', role: 'student', institutionId: instIds[0], isActivated: true },
    { fullName: 'سارة علي', phone: '0770000002', email: 'seed_student2@uniride.local', password: '123456', role: 'student', institutionId: instIds[0], isActivated: true },
    { fullName: 'خالد حسين', phone: '0770000003', email: 'seed_student3@uniride.local', password: '123456', role: 'student', institutionId: instIds[1], isActivated: true },
    { fullName: 'محمد كاظم', phone: '0770000004', email: 'seed_driver1@uniride.local', password: '123456', role: 'driver', institutionId: instIds[0], isActivated: true },
    { fullName: 'علي فاضل', phone: '0770000005', email: 'seed_driver2@uniride.local', password: '123456', role: 'driver', institutionId: instIds[1], isActivated: true },
